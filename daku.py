...
TELEGRAM_BOT_TOKEN = '7351482164:AAGiJbvcqRHgo9vqMOyn54P6h4XAupTv8Dk'
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*❄️ WELCOME TO ROXZ VIP DDOS BOT ❄️*\n\n"
...
async def (update: Update, context: CallbackContext):
    chat_id = update.effective_chat.id
    args = context.args
    ...
    if port in restricted_ports or (100 <= port <= 999):
        await context.bot.send_message(
            ...
            text=(
                ...
                "*📺 LINK: https://youtu.be/JwwbJIOtaEY?si=EU2vlUBBE-hC-vA4*"
            ),
            parse_mode='Markdown'
        )
        return
...
def main():
    ...
    application.add_handler(CommandHandler("roxz", daku))
